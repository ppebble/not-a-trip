      ...
      <div className="space-y-6 p-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-500">{report.address}</p>
          </div>
        ...
        <section className="rounded-lg border border-neutral-200 bg-white p-4">
          ...
          <dl className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div>
              <dt className="text-neutral-400">제보자</dt>
              <dd className="mt-0.5 font-medium text-neutral-700">
                {report.reporterName}
              </dd>
            </div>
            ...
            <div>
              <dt className="text-neutral-400">좌표</dt>
              <dd className="mt-0.5 font-medium text-neutral-700">
          ...
          {report.description && (
            <div className="mt-3 border-t border-neutral-100 pt-3">
              <dt className="text-sm text-neutral-400">설명</dt>
            ...
            <div className="space-y-2">
              {report.relatedContent.map((content, idx) => (
                ...
                >
                  ...
                  {content.year && (
                    <span className="text-neutral-400">({content.year})</span>
                  )}
                </div>
              ))}
            </div>
              ...
              {report.evidencePairs.map((pair, idx) => (
                <div key={idx} className="rounded-lg bg-neutral-50 p-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <p className="mb-1 text-xs text-neutral-400">작품 캡처</p>
                    ...
                    <div>
                      <p className="mb-1 text-xs text-neutral-400">현장 사진</p>
                      <div className="relative aspect-video overflow-hidden rounded-lg">
                        <Image
              ...
              {report.reviewHistory.map(
                (history: ReviewHistory, idx: number) => (
                  <div key={idx} className="relative">
                    {/* 타임라인 도트 */}
                    <div className="absolute -left-4 top-1.5 h-3 w-3 rounded-full border-2 border-white bg-neutral-400" />
          ...
          <section className="rounded-lg border border-neutral-200 bg-white p-4">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <button
                ...
                disabled={loading}
                className="flex-1 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-700 disabled:opacity-50"
              >
                {loading ? '처리중...' : '✏️ 수정요청'}
              </button>
              <button
        ...
        {!isPending && (
          <div className="rounded-lg bg-neutral-50 p-4 text-center text-sm text-neutral-500">
            ...
            {report.reviewComment && (
              <p className="mt-1 text-neutral-600">💬 {report.reviewComment}</p>
            )}
          </div>
        )}
      </div>
