...
3. WHEN NEXTAUTH_URL이 설정되면, THE Env_Checker SHALL 프로덕션 도메인 URL(https://)이 올바르게 설정되어 있는지 확인한다
...
7. IF NEXTAUTH_SECRET이 기본값(your-secret-key-here)이거나 16자 미만이면, THEN THE Env_Checker SHALL 보안 취약 경고를 출력한다
