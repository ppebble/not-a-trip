...
- [ ] 14. 인증 시스템 구현
  ...
  - [ ] 14.5 인증 상태 관리
    ...
    - 로그인/로그아웃 시 상태 업데이트
    - _Requirements: N/A_
  - [ ] 14.6 보호된 라우트 및 UI 구현
    - 로그인 필요 페이지 접근 제어
    - 헤더에 로그인/로그아웃 버튼
    - 게시글 작성 시 로그인 필수 처리
    - _Requirements: 5.2_

- [ ] 15. Checkpoint - 추가 기능 완료 확인
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 16. 반응형 디자인 및 마무리
  ...
  - [ ] 16.3 에러 핸들링 및 로딩 상태 구현
    - API 에러 처리
    - 로딩 스켈레톤/스피너
    - _Requirements: 5.5_

- [ ] 17. Final Checkpoint - 전체 기능 완료 확인
  - Ensure all tests pass, ask the user if questions arise.
