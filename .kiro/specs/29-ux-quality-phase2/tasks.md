...
- [ ] 3. 스팟/코스 공유 기능 구현
  ...
  - [ ] 3.5 RouteDetailContent에 ShareButton 연동
...
- [ ] 5. 신규 사용자 온보딩 가이드 투어 구현
  - [ ] 5.1 useOnboarding 훅 생성
  ...
  - [ ] 5.2 OnboardingTour 오버레이 컴포넌트 생성
