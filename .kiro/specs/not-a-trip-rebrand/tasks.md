...
- [x] 11. 데이터 마이그레이션
  ...
  - [x] 11.4 실제 스팟 데이터 추가
    ...
    - 스포츠: 축구/야구 경기장 및 관련 장소 (5개 이상)
    - 영화/드라마: 촬영지 명소 (5개 이상)
    - 음악/콘서트: 공연장 및 아티스트 관련 장소 (5개 이상)
    - 게임: e스포츠 경기장 및 게임 관련 장소 (3개 이상)
    - 실제 좌표, 주소, 설명 포함
  - [x] 11.5 실제 편의시설 데이터 추가
    - `scripts/seed-real-facilities.ts` 업데이트
    - 각 스팟 주변의 실제 편의시설 데이터 추가
    - 음식점, 편의점, 카페, 역 등 실제 정보 포함

- [x] 12. 스팟 상세 페이지 카테고리 표시
  - [x] 12.1 스팟 상세 페이지 카테고리 UI 추가
    - 카테고리 아이콘 및 라벨 표시
    - `src/app/spots/[id]/page.tsx` 수정
    - _Requirements: 2.3_
  - [x] 12.2 관련 콘텐츠 표시 업데이트
